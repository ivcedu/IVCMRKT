...
//                $('#web_update_existing_url_view').html(result[0]['ckb_web_update_url']);
                $('#web_update_existing_url_view').html("<a target='_blank' href='"+result[0]['ckb_web_update_url']+"'>"+result[0]['ckb_web_update_url']+"</a>");
            }
            else {
...
//                $('#web_add_page_url_view').html(result[0]['ckb_web_add_url']);
                $('#web_add_page_url_view').html("<a target='_blank' href='"+result[0]['ckb_web_add_url']+"'>"+result[0]['ckb_web_add_url']+"</a>");
            }
            else {
