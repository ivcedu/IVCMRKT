...
window.onload = function() {
    ...
    sessionStorage.setItem('ss_mrkt_referrer', "adminNewList.html");
    getLoginInfo();
    getAdminNewList();
};
////////////////////////////////////////////////////////////////////////////////
$(document).ready(function() {
    ...
    $('#mod_btn_ivc_tech_submit').click(function() { 
        if (!appSystemTechSupport("Application Web Site: Marketing and Creative Services Request - MRKT Staff New Request List<br/><br/>", $('#mod_ivc_tech_problems').val(), str_img)) {
    ...
    m_table = $('#tbl_new_req_list').DataTable({ paging: false, bInfo: false,
                                                    dom: "<'row'<'col-sm-4'l><'col-sm-4 text-center'B><'col-sm-4'f>>tp",
                                                    "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
                                                    buttons: [  {extend: 'copy',className: 'btn-sm'},
                                                                {extend: 'csv',title: 'ivcmrkt_new_list_export_csv', className: 'btn-sm'},
                                                                {extend: 'pdf', title: 'ivcmrkt_new_list_export_pdf', className: 'btn-sm'},
