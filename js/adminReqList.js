...
function getAdminReqList() {
    ...
    for (var i = 0; i < result.length; i++) {
        html += setAdminReqListHTML(result[i]['EventRequestID'], result[i]['ReqTitle'], result[i]['ReqDate'], result[i]['ReqName'], result[i]['Status'], result[i]['RequestType'], result[i]['DeliveryType']);
    }
...
function setAdminReqListHTML(event_request_id, req_title, req_date, req_name, status, req_type, del_type) {                                
    var html = "<tr>";
