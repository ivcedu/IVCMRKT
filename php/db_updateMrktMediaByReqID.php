<?php
    ...
    $query = "UPDATE [".$dbDatabase."].[dbo].[MrktMedia] "
                . "SET AdminID = '".$AdminID."', StatusID = '".$StatusID."', ckb_mda_collegewide_email = '".$ckb_mda_collegewide_email."', ckb_mda_sherpa_email = '".$ckb_mda_sherpa_email."', "
                . "ckb_mda_monitor = '".$ckb_mda_monitor."', ckb_mda_social_media = '".$ckb_mda_social_media."', Modified = getdate() "
