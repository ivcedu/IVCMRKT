<?php
    ...
    $query = "UPDATE [".$dbDatabase."].[dbo].[MrktWeb] "
                ...
                . "ckb_web_create_new = '".$ckb_web_create_new."', ckb_web_update_existing = '".$ckb_web_update_existing."', ckb_web_update_url = '".$ckb_web_update_url."', "
                . "ckb_web_add_page = '".$ckb_web_add_page."', ckb_web_add_url = '".$ckb_web_add_url."', "
                . "ckb_web_request_website = '".$ckb_web_request_website."', ckb_web_report_problem = '".$ckb_web_report_problem."', Modified = getdate() "
